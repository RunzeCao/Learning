...
public class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth = resources.getDrawable(R.mipmap.camera_crop_width);
        mResizeDrawableHeight = resources.getDrawable(R.mipmap.camera_crop_height);
        mResizeDrawableDiagonal = resources.getDrawable(R.mipmap.camera_autocrop);
    }
